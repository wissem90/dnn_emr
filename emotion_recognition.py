...
class EmotionRecognition:
  ...
  def build_network(self):
    ...
    self.model = tflearn.DNN(
      self.network,
      checkpoint_path = SAVE_DIRECTORY + '/model_1_nimish',
      max_checkpoints = 1,
  ...
  def load_model(self):
    if isfile(join(SAVE_DIRECTORY, 'model_1_nimish.tflearn.meta')):
...
def show_usage():
  ...
  print('\t emotion_recognition.py live \t Launch the live demo')
